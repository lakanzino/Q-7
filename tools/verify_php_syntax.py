...
php_file = Path('article-rewrite-2026-09-22/importers/glossary-tamrank-seo-fix/qpedia-glossary-tamrank-seo-fix/qpedia-glossary-tamrank-seo-fix.php')
...
assert '$terms_data' in vars_found
print('VERIFICATION PASSED! All variables and syntax structures are 100% correct.')
