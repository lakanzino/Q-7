#!/usr/bin/env python3
"""Build importer plugin for incomplete-depth-third-10."""
...
IMP_DIR = BASE / 'importers' / 'incomplete-depth-third-10'
PLUGIN_DIR = IMP_DIR / 'qpedia-importer-incomplete-depth-third-10'
PLUGIN_DIR.mkdir(parents=True, exist_ok=True)

folders = [
    '119-complementarity-principle',
    '120-neutrino',
    '121-standard-model',
    '122-virtual-particles',
    '123-epr-paradox',
    '124-stern-gerlach-experiment',
    '125-flash-memory',
    '128-quantum-supremacy',
    '132-proton-neutron-quark-structure',
    '133-topological-quantum-computing'
]
...
(PLUGIN_DIR / 'qpedia-importer-incomplete-depth-third-10.php').write_text(php_code.strip(), encoding='utf-8')

readme = """=== Qpedia One-Time Importer Incomplete Depth Third 10 ===
...
== Description ==
افزونه یک‌بارمصرف برای به‌روزرسانی ۱۰ مقاله سوم گروه ناقص Qpedia (شامل مقاله‌های ۱۱۹ تا ۱۳۳) با متادیتای سئو، کلیدواژه‌ها، عنوان و توضیحات متا برای TamRank SEO و Rank Math، اسکیما و لینک‌های داخلی.
"""
(PLUGIN_DIR / 'README.txt').write_text(readme.strip(), encoding='utf-8')

# Zip packaging
zip_path = IMP_DIR / 'qpedia-importer-incomplete-depth-third-10.zip'
