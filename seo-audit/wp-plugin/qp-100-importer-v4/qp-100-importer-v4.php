<?php
/**
 * Plugin Name: QP 100 Importer v4 v1 v1 — 6 مقاله 100 امتیازی qpedia.ir
 ...
 * License: GPL-2.0+
 * Text Domain: qp100v4v1
 */

if (!defined('ABSPATH')) { exit; }

require_once plugin_dir_path(__FILE__) . 'qp-import-data-v4.php';
...
function qp100_data() {
    return qp100v4_import_data();
}

function qp100_admin_menu() {
    add_management_page(
        'QP 100 Importer v4 v1',
        'QP 100 Importer v4 v1',
        'manage_options',
        'qp-100-importer-v1',
        'qp100_render_admin'
...
function qp100_render_admin() {
    ...
    echo '<h1>QP 100 Importer v4 v1 — واردکننده 5 مقاله 100 امتیازی</h1>';
