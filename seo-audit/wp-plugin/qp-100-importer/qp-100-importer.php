<?php
/**
 * Plugin Name: QP 100 Importer v1 v1 — 6 مقاله 100 امتیازی qpedia.ir
...
require_once plugin_dir_path(__FILE__) . 'qp-import-data.php';
...
function qp100_render_admin() {
    ...
    echo '<h1>QP 100 Importer v1 — واردکننده 5 مقاله 100 امتیازی</h1>';
