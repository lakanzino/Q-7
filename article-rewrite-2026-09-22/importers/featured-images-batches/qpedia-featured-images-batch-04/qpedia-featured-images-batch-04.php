 ...
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP (بسته شماره 04 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
...
function qp_fimg_b04_render_page() {
    ...
    echo '<li><strong>نامساوی بل</strong> (<code>bell-inequality</code>) &larr; <code>bell-inequality.webp</code></li>';
    ...
    echo '<li><strong>نامساوی بل (آزمون بل)</strong> (<code>loophole-free-bell-test</code>) &larr; <code>loophole-free-bell-test.webp</code></li>';
