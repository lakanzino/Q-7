<?php
/**
 * Plugin Name: Qpedia Featured Images - Batch 12 (1 Images)
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP (بسته شماره 12 شامل 1 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
...
function qp_fimg_b12_render_page() {
    ...
    echo '<h2>فهرست مقالات و تصاویر این بسته (1 تصویر):</h2>';
