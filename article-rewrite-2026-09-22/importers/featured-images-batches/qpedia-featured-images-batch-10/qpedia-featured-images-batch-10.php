 ...
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP (بسته شماره 10 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
...
function qp_fimg_b10_render_page() {
    ...
    echo '<li><strong>جهان‌های موازی</strong> (<code>is-many-worlds-real</code>) &larr; <code>is-many-worlds-real.webp</code></li>';
    echo '</ol>';
