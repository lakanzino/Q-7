<?php
/**
 * Plugin Name: Qpedia One-Time Importer 011–015
...
const QP5_OPTION = 'qpedia_importer_011_015_completed';

add_action('admin_menu', function () {
    add_management_page('درون‌ریز Qpedia 011–015', 'درون‌ریز Qpedia 011–015', 'manage_options', 'qpedia-importer-011-015', 'qp5_render_page');
});

function qp5_render_page() {
    if (!current_user_can('manage_options')) return;
    $done = get_option(QP5_OPTION);
    echo '<div class="wrap" dir="rtl"><h1>درون‌ریز یک‌بارمصرف مقاله‌های ۱۱ تا ۱۵</h1>';
    if ($done) {
    ...
    submit_button('به‌روزرسانی مقاله‌های ۱۱ تا ۱۵', 'primary', 'qp5_run');
    echo '</form></div>';
}
