<?php
/**
 * Plugin Name: Qpedia Featured Images - Batch 17 (5 Images)
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 17 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
 * Text Domain: qpedia-featured-images-batch-17
 */

defined('ABSPATH') || exit;

add_action('admin_menu', 'qp_fimg_b17_admin_menu');
function qp_fimg_b17_admin_menu() {
    add_management_page(
        'تصاویر شاخص کوانتوم - بسته 17',
        'تصاویر شاخص بسته 17',
        'manage_options',
        'qpedia-featured-images-batch-17',
        'qp_fimg_b17_render_page'
    );
}

function qp_fimg_b17_render_page() {
    if (!current_user_can('manage_options')) {
        return;
    }

    echo '<div class="wrap" dir="rtl" style="font-family:Tahoma,sans-serif;line-height:1.7;">';
    echo '<h1>🖼️ تنظیم و جایگزینی تصاویر شاخص WebP - بسته 17</h1>';

    if (isset($_POST['qp_run_attach'])) {
        check_admin_referer('qp_attach_nonce_17');
        $result = qp_fimg_b17_execute();
    ...
    echo '<li><strong>کوانتوم در پژوهش سرطان</strong> (<code>quantum-cancer</code>) &larr; <code>quantum-cancer.webp</code></li>';
    echo '<li><strong>پیام‌رسانی سلولی کوانتومی</strong> (<code>quantum-cell-signaling</code>) &larr; <code>quantum-cell-signaling.webp</code></li>';
    echo '<li><strong>گربه چشایر کوانتومی</strong> (<code>quantum-cheshire-cat</code>) &larr; <code>quantum-cheshire-cat.webp</code></li>';
    echo '<li><strong>کرومودینامیک کوانتومی</strong> (<code>quantum-chromodynamics</code>) &larr; <code>quantum-chromodynamics.webp</code></li>';
    echo '<li><strong>رایانش ابری کوانتومی</strong> (<code>quantum-cloud</code>) &larr; <code>quantum-cloud.webp</code></li>';
    echo '</ol>';

    echo '<form method="post" style="margin-top:20px;">';
    wp_nonce_field('qp_attach_nonce_17');
    submit_button('شروع اتصال و جایگزینی تصاویر شاخص بسته 17', 'primary', 'qp_run_attach');
    echo '</form>';
    echo '</div></div>';
}

function qp_fimg_b17_execute() {
    ...
    $msg = 'عملیات بسته ' . 17 . ' به پایان رسید: ' . $count_ok . ' تصویر شاخص با موفقیت متصل گردید.';
