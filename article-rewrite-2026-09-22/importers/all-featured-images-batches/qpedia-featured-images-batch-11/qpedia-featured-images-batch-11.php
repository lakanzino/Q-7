 ...
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 11 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
...
function qp_fimg_b11_render_page() {
    ...
    echo '<li><strong>اثر کوندو</strong> (<code>kondo-effect</code>) &larr; <code>kondo-effect.webp</code></li>';
    ...
    echo '<li><strong>مگنون و موج اسپینی</strong> (<code>magnon</code>) &larr; <code>magnon.webp</code></li>';
    echo '<li><strong>فرمیون مایورانا</strong> (<code>majorana-fermion</code>) &larr; <code>majorana-fermion.webp</code></li>';
    echo '</ol>';
