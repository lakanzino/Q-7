 ...
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 08 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
...
function qp_fimg_b08_render_page() {
    ...
    echo '<li><strong>درهم‌تنیدگی در کامپیوترهای کوانتومی</strong> (<code>entanglement-quantum-computers</code>) &larr; <code>entanglement-quantum-computers.webp</code></li>';
    echo '<li><strong>اکسایتون در شبکه بلوری</strong> (<code>exciton</code>) &larr; <code>exciton.webp</code></li>';
    echo '<li><strong>گاز فرمی و پرشدن ترازها تا انرژی فرمی</strong> (<code>fermi-gas</code>) &larr; <code>fermi-gas.webp</code></li>';
    echo '<li><strong>ثابت ساختار ریز</strong> (<code>fine-structure-constant</code>) &larr; <code>fine-structure-constant.webp</code></li>';
    echo '<li><strong>حالت فوک با تعداد مشخص کوانتوم</strong> (<code>fock-state</code>) &larr; <code>fock-state.webp</code></li>';
    echo '</ol>';
