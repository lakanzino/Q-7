<?php
/**
 * Plugin Name: Qpedia Featured Images - Batch 20 (5 Images)
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 20 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
 * Text Domain: qpedia-featured-images-batch-20
 */

defined('ABSPATH') || exit;

add_action('admin_menu', 'qp_fimg_b20_admin_menu');
function qp_fimg_b20_admin_menu() {
    add_management_page(
        'تصاویر شاخص کوانتوم - بسته 20',
        'تصاویر شاخص بسته 20',
        'manage_options',
        'qpedia-featured-images-batch-20',
        'qp_fimg_b20_render_page'
    );
}

function qp_fimg_b20_render_page() {
    if (!current_user_can('manage_options')) {
        return;
    }

    echo '<div class="wrap" dir="rtl" style="font-family:Tahoma,sans-serif;line-height:1.7;">';
    echo '<h1>🖼️ تنظیم و جایگزینی تصاویر شاخص WebP - بسته 20</h1>';

    if (isset($_POST['qp_run_attach'])) {
        check_admin_referer('qp_attach_nonce_20');
        $result = qp_fimg_b20_execute();
    ...
    echo '<li><strong>قطره کوانتومی خودبسته</strong> (<code>quantum-droplet</code>) &larr; <code>quantum-droplet.webp</code></li>';
    echo '<li><strong>الکترودینامیک کوانتومی</strong> (<code>quantum-electrodynamics</code>) &larr; <code>quantum-electrodynamics.webp</code></li>';
    echo '<li><strong>بازده موتور کوانتومی</strong> (<code>quantum-engine-efficiency</code>) &larr; <code>quantum-engine-efficiency.webp</code></li>';
    echo '<li><strong>درهم‌تنیدگی کوانتومی</strong> (<code>quantum-entanglement-explained</code>) &larr; <code>quantum-entanglement-explained.webp</code></li>';
    echo '<li><strong>آنتروپی کوانتومی</strong> (<code>quantum-entropy</code>) &larr; <code>quantum-entropy.webp</code></li>';
    echo '</ol>';

    echo '<form method="post" style="margin-top:20px;">';
    wp_nonce_field('qp_attach_nonce_20');
    submit_button('شروع اتصال و جایگزینی تصاویر شاخص بسته 20', 'primary', 'qp_run_attach');
    echo '</form>';
    echo '</div></div>';
}

function qp_fimg_b20_execute() {
    ...
    $msg = 'عملیات بسته ' . 20 . ' به پایان رسید: ' . $count_ok . ' تصویر شاخص با موفقیت متصل گردید.';
