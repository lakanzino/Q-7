<?php
/**
 * Plugin Name: Qpedia Featured Images - Master All-in-One (172 Images)
 * Description: افزونه جامع تنظیم و جایگزینی یک‌جای تمامی 172 تصویر شاخص بهینه‌شده WebP دانشنامه با نشان qpedia.ir و Alt Text سئو در وردپرس.
 * Version: 1.0.0
 * Author: Qpedia Team
...
function qp_all_fimg_master_render_page() {
    ...
    echo '<h1>🖼️ تنظیم و جایگزینی جامع تمامی 172 تصویر شاخص WebP</h1>';
    ...
    echo '<p>این افزونه شامل تمامی <strong>172 تصویر شاخص</strong> با نشان استاندارد <code>qpedia.ir</code>، ابعاد 16:9 WebP و متن‌های جایگزین سئو است و با یک کلیک تمامی مقالات موجود در سایت را شناسایی و تصاویر شاخص آن‌ها را متصل می‌کند.</p>';

    echo '<form method="post" style="margin-top:20px;">';
    wp_nonce_field('qp_master_attach_nonce');
    submit_button('شروع اتصال یک‌جای تمامی 172 تصویر شاخص', 'primary', 'qp_run_master_attach');
    echo '</form>';
    echo '</div></div>';
}
