<?php
/**
 * Plugin Name: Qpedia Featured Images - Batch 25 (5 Images)
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 25 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
 * Text Domain: qpedia-featured-images-batch-25
 */

defined('ABSPATH') || exit;

add_action('admin_menu', 'qp_fimg_b25_admin_menu');
function qp_fimg_b25_admin_menu() {
    add_management_page(
        'تصاویر شاخص کوانتوم - بسته 25',
        'تصاویر شاخص بسته 25',
        'manage_options',
        'qpedia-featured-images-batch-25',
        'qp_fimg_b25_render_page'
    );
}

function qp_fimg_b25_render_page() {
    if (!current_user_can('manage_options')) {
        return;
    }

    echo '<div class="wrap" dir="rtl" style="font-family:Tahoma,sans-serif;line-height:1.7;">';
    echo '<h1>🖼️ تنظیم و جایگزینی تصاویر شاخص WebP - بسته 25</h1>';

    if (isset($_POST['qp_run_attach'])) {
        check_admin_referer('qp_attach_nonce_25');
        $result = qp_fimg_b25_execute();
    ...
    echo '<li><strong>شبکه کوانتومی</strong> (<code>quantum-network</code>) &larr; <code>quantum-network.webp</code></li>';
    echo '<li><strong>شبکه عصبی کوانتومی</strong> (<code>quantum-neural-network</code>) &larr; <code>quantum-neural-network.webp</code></li>';
    echo '<li><strong>عدد کوانتومی</strong> (<code>quantum-number</code>) &larr; <code>quantum-number.webp</code></li>';
    echo '<li><strong>مدار تخمین فاز کوانتومی</strong> (<code>quantum-phase-estimation</code>) &larr; <code>quantum-phase-estimation.webp</code></li>';
    echo '<li><strong>گذار فاز کوانتومی</strong> (<code>quantum-phase-transition</code>) &larr; <code>quantum-phase-transition.webp</code></li>';
    echo '</ol>';

    echo '<form method="post" style="margin-top:20px;">';
    wp_nonce_field('qp_attach_nonce_25');
    submit_button('شروع اتصال و جایگزینی تصاویر شاخص بسته 25', 'primary', 'qp_run_attach');
    echo '</form>';
    echo '</div></div>';
}

function qp_fimg_b25_execute() {
    ...
    $msg = 'عملیات بسته ' . 25 . ' به پایان رسید: ' . $count_ok . ' تصویر شاخص با موفقیت متصل گردید.';
