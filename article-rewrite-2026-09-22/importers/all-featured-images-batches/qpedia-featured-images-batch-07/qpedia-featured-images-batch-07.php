 ...
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 07 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
...
function qp_fimg_b07_render_page() {
    ...
    echo '<li><strong>آزمایش دو شکاف</strong> (<code>double-slit-experiment</code>) &larr; <code>double-slit-experiment.webp</code></li>';
    echo '<li><strong>فرضیه گرمایی‌شدن حالت ویژه</strong> (<code>eigenstate-thermalization</code>) &larr; <code>eigenstate-thermalization.webp</code></li>';
    echo '<li><strong>شفافیت القایی الکترومغناطیسی</strong> (<code>electromagnetically-induced-transparency</code>) &larr; <code>electromagnetically-induced-transparency.webp</code></li>';
    echo '<li><strong>نظریه الکتروضعیف</strong> (<code>electroweak-theory</code>) &larr; <code>electroweak-theory.webp</code></li>';
    echo '<li><strong>ترازهای انرژی و کوانتش</strong> (<code>energy-levels</code>) &larr; <code>energy-levels.webp</code></li>';
    echo '</ol>';
