<?php
/**
 * Plugin Name: Qpedia Featured Images - Batch 26 (5 Images)
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 26 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
 * Text Domain: qpedia-featured-images-batch-26
 */

defined('ABSPATH') || exit;

add_action('admin_menu', 'qp_fimg_b26_admin_menu');
function qp_fimg_b26_admin_menu() {
    add_management_page(
        'تصاویر شاخص کوانتوم - بسته 26',
        'تصاویر شاخص بسته 26',
        'manage_options',
        'qpedia-featured-images-batch-26',
        'qp_fimg_b26_render_page'
    );
}

function qp_fimg_b26_render_page() {
    if (!current_user_can('manage_options')) {
        return;
    }

    echo '<div class="wrap" dir="rtl" style="font-family:Tahoma,sans-serif;line-height:1.7;">';
    echo '<h1>🖼️ تنظیم و جایگزینی تصاویر شاخص WebP - بسته 26</h1>';

    if (isset($_POST['qp_run_attach'])) {
        check_admin_referer('qp_attach_nonce_26');
        $result = qp_fimg_b26_execute();
    ...
    echo '<li><strong>اصل لانه‌کبوتری کوانتومی</strong> (<code>quantum-pigeonhole</code>) &larr; <code>quantum-pigeonhole.webp</code></li>';
    echo '<li><strong>احتمال کوانتومی</strong> (<code>quantum-probability</code>) &larr; <code>quantum-probability.webp</code></li>';
    echo '<li><strong>زبان برنامه‌نویسی کوانتومی</strong> (<code>quantum-programming-language</code>) &larr; <code>quantum-programming-language.webp</code></li>';
    echo '<li><strong>مولد عدد تصادفی کوانتومی</strong> (<code>quantum-random-number-generator</code>) &larr; <code>quantum-random-number-generator.webp</code></li>';
    echo '</ol>';

    echo '<form method="post" style="margin-top:20px;">';
    wp_nonce_field('qp_attach_nonce_26');
    submit_button('شروع اتصال و جایگزینی تصاویر شاخص بسته 26', 'primary', 'qp_run_attach');
    echo '</form>';
    echo '</div></div>';
}

function qp_fimg_b26_execute() {
    ...
    $msg = 'عملیات بسته ' . 26 . ' به پایان رسید: ' . $count_ok . ' تصویر شاخص با موفقیت متصل گردید.';
