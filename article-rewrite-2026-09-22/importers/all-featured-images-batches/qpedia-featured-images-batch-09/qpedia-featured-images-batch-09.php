 ...
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 09 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
...
function qp_fimg_b09_render_page() {
    ...
    echo '<li><strong>فرایند چهارموجی در محیط غیرخطی</strong> (<code>four-wave-mixing</code>) &larr; <code>four-wave-mixing.webp</code></li>';
    echo '<li><strong>اثر هال کوانتومی کسری</strong> (<code>fractional-quantum-hall-effect</code>) &larr; <code>fractional-quantum-hall-effect.webp</code></li>';
    echo '<li><strong>حالت درهم‌تنیده GHZ</strong> (<code>ghz-state</code>) &larr; <code>ghz-state.webp</code></li>';
    echo '<li><strong>چیدمان پارادوکس هاردی</strong> (<code>hardy-paradox</code>) &larr; <code>hardy-paradox.webp</code></li>';
    echo '<li><strong>فرمیون سنگین</strong> (<code>heavy-fermion</code>) &larr; <code>heavy-fermion.webp</code></li>';
    echo '</ol>';
