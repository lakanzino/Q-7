 ...
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 02 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
...
function qp_fimg_b02_render_page() {
    ...
    echo '<li><strong>آنیون و آمار ذرات دوبعدی</strong> (<code>anyon</code>) &larr; <code>anyon.webp</code></li>';
    echo '<li><strong>اکسیون</strong> (<code>axion</code>) &larr; <code>axion.webp</code></li>';
    echo '<li><strong>نامساوی بل</strong> (<code>bell-inequality</code>) &larr; <code>bell-inequality.webp</code></li>';
    echo '<li><strong>مدار الگوریتم برنشتاین–وزیرانی</strong> (<code>bernstein-vazirani-algorithm</code>) &larr; <code>bernstein-vazirani-algorithm.webp</code></li>';
    echo '<li><strong>مدل اتمی بور</strong> (<code>bohr-atomic-model</code>) &larr; <code>bohr-atomic-model.webp</code></li>';
    echo '</ol>';
