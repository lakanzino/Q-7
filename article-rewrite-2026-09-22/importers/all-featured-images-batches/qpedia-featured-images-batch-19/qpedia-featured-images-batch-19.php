<?php
/**
 * Plugin Name: Qpedia Featured Images - Batch 19 (5 Images)
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 19 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
 * Text Domain: qpedia-featured-images-batch-19
 */

defined('ABSPATH') || exit;

add_action('admin_menu', 'qp_fimg_b19_admin_menu');
function qp_fimg_b19_admin_menu() {
    add_management_page(
        'تصاویر شاخص کوانتوم - بسته 19',
        'تصاویر شاخص بسته 19',
        'manage_options',
        'qpedia-featured-images-batch-19',
        'qp_fimg_b19_render_page'
    );
}

function qp_fimg_b19_render_page() {
    if (!current_user_can('manage_options')) {
        return;
    }

    echo '<div class="wrap" dir="rtl" style="font-family:Tahoma,sans-serif;line-height:1.7;">';
    echo '<h1>🖼️ تنظیم و جایگزینی تصاویر شاخص WebP - بسته 19</h1>';

    if (isset($_POST['qp_run_attach'])) {
        check_admin_referer('qp_attach_nonce_19');
        $result = qp_fimg_b19_execute();
    ...
    echo '<li><strong>بحرانیت کوانتومی</strong> (<code>quantum-criticality</code>) &larr; <code>quantum-criticality.webp</code></li>';
    echo '<li><strong>فرهنگ کوانتومی</strong> (<code>quantum-culture</code>) &larr; <code>quantum-culture.webp</code></li>';
    echo '<li><strong>داروینیسم کوانتومی</strong> (<code>quantum-darwinism</code>) &larr; <code>quantum-darwinism.webp</code></li>';
    echo '<li><strong>امضای دیجیتال کوانتومی</strong> (<code>quantum-digital-signature</code>) &larr; <code>quantum-digital-signature.webp</code></li>';
    echo '<li><strong>دیمر کوانتومی و پیوند میان دو جایگاه</strong> (<code>quantum-dimer</code>) &larr; <code>quantum-dimer.webp</code></li>';
    echo '</ol>';

    echo '<form method="post" style="margin-top:20px;">';
    wp_nonce_field('qp_attach_nonce_19');
    submit_button('شروع اتصال و جایگزینی تصاویر شاخص بسته 19', 'primary', 'qp_run_attach');
    echo '</form>';
    echo '</div></div>';
}

function qp_fimg_b19_execute() {
    ...
    $msg = 'عملیات بسته ' . 19 . ' به پایان رسید: ' . $count_ok . ' تصویر شاخص با موفقیت متصل گردید.';
