<?php
/**
 * Plugin Name: Qpedia Featured Images - Batch 18 (5 Images)
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 18 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
 * Text Domain: qpedia-featured-images-batch-18
 */

defined('ABSPATH') || exit;

add_action('admin_menu', 'qp_fimg_b18_admin_menu');
function qp_fimg_b18_admin_menu() {
    add_management_page(
        'تصاویر شاخص کوانتوم - بسته 18',
        'تصاویر شاخص بسته 18',
        'manage_options',
        'qpedia-featured-images-batch-18',
        'qp_fimg_b18_render_page'
    );
}

function qp_fimg_b18_render_page() {
    if (!current_user_can('manage_options')) {
        return;
    }

    echo '<div class="wrap" dir="rtl" style="font-family:Tahoma,sans-serif;line-height:1.7;">';
    echo '<h1>🖼️ تنظیم و جایگزینی تصاویر شاخص WebP - بسته 18</h1>';

    if (isset($_POST['qp_run_attach'])) {
        check_admin_referer('qp_attach_nonce_18');
        $result = qp_fimg_b18_execute();
    ...
    echo '<li><strong>کامپایلر کوانتومی</strong> (<code>quantum-compiler</code>) &larr; <code>quantum-compiler.webp</code></li>';
    echo '<li><strong>توافق کلید کوانتومی</strong> (<code>quantum-conference-key-agreement</code>) &larr; <code>quantum-conference-key-agreement.webp</code></li>';
    echo '<li><strong>زمینه‌مندی کوانتومی</strong> (<code>quantum-contextuality</code>) &larr; <code>quantum-contextuality.webp</code></li>';
    echo '<li><strong>کنترل کوانتومی سامانه</strong> (<code>quantum-control</code>) &larr; <code>quantum-control.webp</code></li>';
    echo '<li><strong>روند مفهومی کیهان‌شناسی کوانتومی از جهان آغازین</strong> (<code>quantum-cosmology</code>) &larr; <code>quantum-cosmology.webp</code></li>';
    echo '</ol>';

    echo '<form method="post" style="margin-top:20px;">';
    wp_nonce_field('qp_attach_nonce_18');
    submit_button('شروع اتصال و جایگزینی تصاویر شاخص بسته 18', 'primary', 'qp_run_attach');
    echo '</form>';
    echo '</div></div>';
}

function qp_fimg_b18_execute() {
    ...
    $msg = 'عملیات بسته ' . 18 . ' به پایان رسید: ' . $count_ok . ' تصویر شاخص با موفقیت متصل گردید.';
