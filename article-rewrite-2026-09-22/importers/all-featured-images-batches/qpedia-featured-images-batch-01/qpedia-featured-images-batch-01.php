 ...
 * Description: افزونه تنظیم و جایگزینی تصاویر شاخص بهینه‌شده WebP با نشان استاندارد qpedia.ir (بسته شماره 01 شامل 5 مقاله) به همراه متادیتا و Alt Text سئو در Qpedia.
 * Version: 1.0.0
 * Author: Qpedia Team
...
function qp_fimg_b01_render_page() {
    ...
    echo '<li><strong>صفر مطلق چیست؟</strong> (<code>absolute-zero</code>) &larr; <code>absolute-zero.webp</code></li>';
    echo '<li><strong>اثر شتاب و تابش اونرو</strong> (<code>acceleration-radiation</code>) &larr; <code>acceleration-radiation.webp</code></li>';
    echo '<li><strong>اثر آهارونوف-بوهم</strong> (<code>aharonov-bohm-effect</code>) &larr; <code>aharonov-bohm-effect.webp</code></li>';
    echo '<li><strong>واپاشی آلفا</strong> (<code>alpha-decay</code>) &larr; <code>alpha-decay.webp</code></li>';
    echo '<li><strong>گشتاور مغناطیسی ناهنجار</strong> (<code>anomalous-magnetic-moment</code>) &larr; <code>anomalous-magnetic-moment.webp</code></li>';
    echo '</ol>';
